...
export const MOVEFLOW_BADGES_SCRIPT =
  "https://moveflow.cloud/widgets/badges/loader.js";

export const MOVEFLOW_BADGES_IFRAME_SRC =
  "https://moveflow.cloud/embed/badges/sw-london-removals?variant=shield-seal&theme=light&layout=row&bg=0&title=Accredited+%26+verified";
